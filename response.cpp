...
/*   Updated: 2024/02/17 13:06:03 by adardour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void autoIndexing(request &req, Worker &wk,std::string &response_head, std::string &body, std::map<unsigned int, std::string> &status_codes)
{
    ...
    body = "<html>\n<head>\n<title>Index of " + uri.path + "</title>\n<style>\nbody { font-family: Arial, sans-serif; }\ntable { width: 100%; border-collapse: collapse; }\nthead { background-color: #f2f2f2; }\nth, td { padding: 8px; text-align: left; }\nth { background-color: #4CAF50; color: white; }\na { text-decoration: none; color: #007bff; }\na:hover { text-decoration: underline; }\n</style>\n</head>\n<body>\n";
    body += "<h1>Index of " + uri.path + "</h1>\n";
    ...
    body += "<div style=\"margin-bottom: 20px;\"><strong>Number of Files:</strong> " + std::to_string(num_files) + "</div>\n";
    body += "<div style=\"margin-bottom: 20px;\"><strong>Number of Directories:</strong> " + std::to_string(num_dirs) + "</div>\n";
